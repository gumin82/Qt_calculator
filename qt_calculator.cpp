...
QPushButton* Qt_calculator::createButton(const QString &text, const char* slot)
{
...
void Qt_calculator::digitClicked()
{
...
void Qt_calculator::decimalClicked()
{
    if (waitingForOperand) {
        currentNumber = "0.";
        waitingForOperand = false;
...
void Qt_calculator::operatorClicked()
{
    QPushButton *button = qobject_cast<QPushButton*>(sender());
...
void Qt_calculator::equalClicked()
{
...
void Qt_calculator::clearClicked()
{
    currentNumber = "0";
    operand1.clear();
    currentOperator.clear();
...
void Qt_calculator::backspaceClicked()
{
